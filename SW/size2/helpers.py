...
def printmetrics(y_test, pred):
    ...
    f1Score = round(f1_score(y_test, pred, average = 'weighted'), 4)
    recallScore = round(recall_score(y_test, pred, average = 'weighted'), 4)
    precisionScore = round(precision_score(y_test, pred, average = 'weighted'), 4)
    accuracy = round(accuracy_score(y_test, pred),4)
    print(cmat)
    print(f"Sensitivity/Recall : {100 * recallScore:.2f} %")
    print(f"Precision          : {100 * precisionScore:.2f} %")
